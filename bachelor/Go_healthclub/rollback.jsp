...
<%
   ...
   String sql = "select * from disuser order by name";
...
<form  name = "check" method = "get" action = "rollbackDelete.jsp">
<div id = "content">
   <div id = "top-rap">
      <div id = "top-text">회원정보조회
      </div>
      <div id = "top-button">
         <input type = "submit" id = "delete-button"  value = "영구삭제">
         <input type = "submit" id = "rollback-button" formaction = "rollbackToBasic.jsp" value = "복구완료">
      </div>
   </div>
