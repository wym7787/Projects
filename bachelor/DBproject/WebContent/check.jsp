...
<div class = "header">
	<div class = "top">
		<div class ="main">
			<a href="#"><img class = "mainlogo" src="img/main.jpg"/></a>
		</div>
	</div>
</div>
...
<div id="sign-container">
			<div class ="sign-nav">
				...
				<a class ="button" href="check.jsp">전체조회</a>
				</div>
			</div>

</div>
</form>
<form name="input_form" method="post" action = "check.jsp">
...
<div id ="button-sort">
	<a class = "button" onclick= "fail();">취소</a>
</div>
