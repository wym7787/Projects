	...
	<div class ="top-content">
		<div class ="toprap">
			<div class ="topsort">
				...
				<div class ="toptext"><h4>삭제 목록</h4></div>
			</div>	
		</div>
	</div>

<form method = "post" action ="prollback.jsp">
<div id="sign-container">
			<div class ="sign-nav">
				...
				<a class ="button" href = "prollback.jsp">전체조회</a>
				</div>
			</div>
...
<div id ="button-sort">
	<a class = "button" href ="psearch.jsp">회원목록</a>
	<a class = "button" onclick = "pdelete2();">영구삭제</a>
	<a class = "button" onclick = "prollback2();">복구</a>
</div>
...
<table id = "container-table">
			...
			<%
				...
				String sql = "select * from dispatient order by pnum"; // default
				...
				if(!pnumber.equals("") && name.equals(""))
				{
					...
					sql = "select * from dispatient where pnum = '" + pnumber + "'";
				...
				if(pnumber.equals("") && !name.equals(""))
				{
					...
					sql = "select * from dispatient where name = '" + name + "'";
					rs = st.executeQuery(sql);
					while(rs.next())
					{
				...
				if(!pnumber.equals("") && !name.equals(""))
				{
					...
					sql = "select * from dispatient where pnum = '" + pnumber +"' and name = '" + name + "'";
					rs = st.executeQuery(sql);
					while(rs.next())
					{
